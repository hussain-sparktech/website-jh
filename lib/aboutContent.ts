...
export const aboutContent: Record<Language, AboutContent> = {
  en: {
    ...
    profile: {
      ...
      credentials: [
        ...
        "Certified Coach since 2006 (ICA-certified)",
        "Lecturer and trainer at the University of St. Gallen (2003–2008)",
  ...
  de: {
    mission: {
      ...
      body: [
        "Transformation erfordert das Schaffen von Erfahrungsräumen, in denen neue Verhaltensweisen und Denkmuster spielerisch und experimentell erprobt werden können. Ziel ist nachhaltige Veränderung, die nicht nur oberflächlich, sondern tief in die kulturellen und organisatorischen Strukturen eingreift. Gemeinsam mit einem Netzwerk aus Kollaborationspartnern, Designern, Entwicklern und Thought Leaders aus verschiedenen Branchen fördere ich den interdisziplinären Austausch und neue Perspektiven."
      ]
    },
    profile: {
      name: "Dr. Jasmina Hasanbegovic",
      ...
      credentials: [
        ...
        "Zertifizierter Coach seit 2006 (ICA-zertifiziert)",
        "Dozentin und Trainerin an der Universität St. Gallen (2003–2008)",
    ...
    network: {
      ...
      body:
        "Bayerischer Sitz mit internationaler Reichweite. Ein Netzwerk mit über 30 Experten aus Strategie-Management, OE & Change, Brand & Communication Design, Entwicklung, Projektmanagement, HR-IT, IT und KI, sowie Training und Prozessbegleitung. Wir arbeiten an der Schnittstelle von Kultur, Lernen und Organisationsentwicklung – mit interdisziplinärer Expertise in jedem Projekt.",
      stat: "30+",
      statLabel: "Experten",
      tags: ["Strategie-Management", "OE & Change", "Brand & Communication Design", "Entwicklung", "HR-IT", "IT und KI", "Prozessbegleitung"]
    },
    closing: {
